...
**Inglês técnico**
- [ ] - Interpretação  de  textos  de  manuais  técnicos;
- [ ] - gramática;
- [ ] - substantivos;
- [ ] - artigos;
- [ ] - adjetivos;
...
- [ ] - arquivos;
- [ ] - modularização e desenvolvimento TOP-DOWN;
- [ ] - orientação a objetos: conceitos fundamentais,  princípios  de  programação  orientada  a  objetos;
- [ ] - arquivo;
- [ ] - registro;
- [ ] - campo;
- [ ] - chave primária,  secundária,  de  acesso,  de ordenação;
...
- [ ] - dispositivos de segurança de redes de computadores: firewalls, conceito de DMZ, detectores de intrusão (IDS e IPS), proxies, NAT, sniffers;
...
- [ ] - modelos relacionais  e  de  entidade-relacionamentos;
- [ ] - linguagem  SQL;
...
- [ ] - arquitetura e protocolos de rede de comunicação;
- [ ] - modelos  de  referência  OSI  e  principais  padrões  internacionais;
...
- [ ] - fases,
- [ ] - ferramentas,
- [ ] - diagramas  e  notações  da  análise  orientada  a  objetos,
- [ ] - análise  estruturada,
